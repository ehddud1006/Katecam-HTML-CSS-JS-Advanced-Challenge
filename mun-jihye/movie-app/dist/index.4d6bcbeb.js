...
exports.default = new (0, _heropy.Store)({
    ...
    name: "HEROPY / Munjihye",
    email: "m84422583@gmail.com",
    blog: "https://heropy.blog",
    github: "https://github.com/mun-jihye",
    repository: "https://github.com/ParkYoungWoong/vanillajs-moive-app"
});
...
class Search extends (0, _heropy.Component) {
    render() {
        ...
        inputEl.addEventListener("keydown", (event)=>{
            if (event.key === "Enter" && (0, _movieDefault.default).state.searchText.trim()) // 엔터 키 누르고 검색 내용이 있으면 검색 해주는 기능 
...
class MoiveList extends (0, _heropy.Component) {
    constructor(){
        super();
...
class MovieListMore extends (0, _heropy.Component) {
    constructor(){
        ...
        (0, _movieDefault.default).subscribe("pageMax", ()=>{
            ...
            // 이렇게 같은 movieStore.state에서 꺼내오는 것은 객체 구조분해 할당 사용 
